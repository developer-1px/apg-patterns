...
const menuDemoDefinition = {
  ...
  sources: {
    ...
    extra: ['menu/menuAriaSources.ts', 'menu/menuButtonDefinition.ts', 'menu/menubarDefinition.ts', 'menu/menuButtonItem.ts', 'menu/menuButtonKeyboard.ts', 'menu/menuButtonProps.ts', 'menu/menubarItem.ts', 'menu/useMenubarTypeahead.ts', 'menu/inspect.ts'],
  },
  controls: {
    kind: 'listbox',
