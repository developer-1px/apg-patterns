...
export const entry: PatternEntry = {
  ...
  useDemoPattern: (onEvent) => {
    ...
    return {
      ...
      sourceNames: ['Tree.tsx', 'TreeVariantMenu.tsx', 'treeVariants.ts', 'treeview/useTreeviewPattern.ts', 'treeview/runtime.ts', 'treeview/definition.ts', ...KERNEL_SOURCES, 'treeContract.ts'],
