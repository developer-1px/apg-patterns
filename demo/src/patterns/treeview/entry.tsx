...
const treeviewDemoDefinition = {
  ...
  sources: {
    ...
    runtime: ['treeview/runtime.ts', 'treeview/navigation.ts', 'treeview/typeahead.ts', 'treeview/keyboard.ts', 'treeview/keyboardBinding.ts', 'treeview/adaptTreeviewProps.ts', 'treeview/adaptTreeviewRuntime.ts', 'treeview/createTreeviewRenderItems.ts', 'treeview/renderItem.ts', 'treeview/treeProps.ts', 'treeview/react.ts', 'treeview/runtimeCompatibility.ts', 'treeview/parts.ts', 'treeview/eventMeta.ts'],
