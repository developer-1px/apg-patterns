...
const treeviewDemoDefinition = {
  ...
  sources: {
    ...
    runtime: ['treeview/runtime.ts', 'treeview/navigation.ts', 'treeview/typeahead.ts', 'treeview/keyboardBinding.ts', 'treeview/adaptTreeviewProps.ts', 'treeview/adaptTreeviewRuntime.ts', 'treeview/createTreeviewRenderItems.ts', 'treeview/renderItem.ts'],
