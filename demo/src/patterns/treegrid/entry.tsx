...
const treegridDemoDefinition = {
  ...
  sources: {
    ...
    extra: ['treegrid/effects.ts', 'treegrid/ariaSources.ts', 'treegrid/navigation.ts', 'treegrid/geometry.ts', 'treegrid/keyboard.ts', 'treegrid/parts.ts', 'treegrid/treegridRow.ts'],
  },
  view: {
    kind: 'component',
    component: 'Treegrid',
