...
export const entry: PatternEntry = {
  ...
  useDemoPattern: (onEvent) => {
    ...
    return {
      ...
      sourceNames: ['Treegrid.tsx', 'treegrid/entry.tsx', 'treegrid/useTreegridPattern.ts', 'treegridData.ts', 'treegrid/definition.ts', 'treegrid/navigation.ts', ...KERNEL_SOURCES],
