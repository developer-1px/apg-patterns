...
const listboxDemoDefinition = {
  ...
  sources: {
    ...
    extra: ['listbox/createListboxRenderItem.ts', 'listbox/createListboxRootProps.ts', 'listbox/handleListboxMultiSelect.ts', 'listbox/resolveListboxTypeaheadTarget.ts', 'listbox/inspect.ts'],
  },
  controls: {
    kind: 'listbox',
