...
export const selectClass = 'h-8 rounded-lg bg-white/70 px-2.5 text-xs font-medium text-zinc-700 shadow-sm outline-none transition focus:bg-white focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-zinc-400 dark:bg-white/[0.06] dark:text-zinc-300 dark:focus:bg-white/[0.08] dark:focus:outline-zinc-500'
