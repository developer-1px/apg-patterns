...
- Package verification covers exports, packed files, actual npm pack tarball integrity, side effects, ESM/CJS runtime imports, README Quick Start type checks, npm tarball installation, Vite bundling, TypeScript consumer imports, and demo smoke tests.
