...
- External release-state verification can check origin alignment, public GitHub visibility and reachability, and current npm registry availability before publishing.
