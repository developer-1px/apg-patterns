...
- Package verification covers repository hygiene, exports, packed files, actual npm pack tarball integrity, published docs, side effects, ESM/CJS runtime imports, README Quick Start type checks, npm tarball installation, Vite bundling, TypeScript consumer imports, and demo smoke tests.
