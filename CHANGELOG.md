...
- `release:check` runs the full local gate, npm registry preflight, and release git-ref preflight before publishing.
- GitHub Actions includes SHA-pinned release and manual trusted-publishing workflows that run the full release preflight, upload the packed package artifact, and publish with npm provenance.
