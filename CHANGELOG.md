...
- Package verification covers repository hygiene, package independence, React peer compatibility, package-lock runtime dependency registry, integrity, and license metadata, conditional ESM/CJS declaration and runtime exports, packed files, actual npm pack tarball integrity, published docs, npm provenance publish dry-run metadata, documented public provenance publish command, side effects, ESM/CJS runtime imports, README Quick Start type checks, npm tarball installation, Vite bundling, TypeScript consumer imports, and demo smoke tests.
