...
export const SliderItemSchema = PatternItemSchema.extend({
  valuemin: z.number().optional(),
  valuemax: z.number().optional(),
  valuetext: z.string().optional(),
})

export const SliderOptionsSchema = PatternOptionsSchema.extend({
  min: z.number().optional(),
  max: z.number().optional(),
  step: z.number().optional(),
})

export const SliderStateSchema = PatternStateSchema.extend({
