...
export const treegridDefinition = PatternDefinitionSchema.parse({
  ...
  keyboard: [
    ...
    { shortcut: 'Control+a', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridSelectAll' }] }] },
    { shortcut: 'Control+Space', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridSelectColumn' }] }] },
    { shortcut: 'Shift+Space', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridSelectRow' }] }] },
    { shortcut: 'Shift+ArrowRight', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridExtendSelection', payload: { direction: 'right' } }] }] },
    { shortcut: 'Shift+ArrowLeft', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridExtendSelection', payload: { direction: 'left' } }] }] },
    { shortcut: 'Shift+ArrowDown', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridExtendSelection', payload: { direction: 'down' } }] }] },
    { shortcut: 'Shift+ArrowUp', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridExtendSelection', payload: { direction: 'up' } }] }] },
    { shortcut: 'Shift+Home', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridExtendSelection', payload: { direction: 'rowStart' } }] }] },
    { shortcut: 'Shift+End', preventDefault: true, cases: [{ case: 'always', events: [{ type: 'extension', name: 'treegridExtendSelection', payload: { direction: 'rowEnd' } }] }] },
