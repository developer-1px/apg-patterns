...
export const DialogDefinitionSchema: ZodType<PatternDefinition> = PatternDefinitionSchema.superRefine((value, ctx) => {
...
export const dialogDefinition: PatternDefinition = DialogDefinitionSchema.parse({
  apgPattern: 'dialog',
  rootRole: 'dialog',
